...
class Arduino_uno_board():
    ...
    def __init__(self, usb_port, analogs=[], output_pins=[], pwm_pins=[], servo_pins=[]):
        ...
        self.t0_record, self.time_list, self.distance_list, self.rotation_list, self.bits_list, self.motor_is_on_list = 0, [], [], [], [], []
    ...
    def stop_recording(self):
        ...
        name = find_file_name()
        success = create_excel(self.time_list, self.distance_list, self.rotation_list, self.bits_list, self.motor_is_on_list, self.path, name)
        if success :
